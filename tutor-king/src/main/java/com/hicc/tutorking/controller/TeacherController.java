...
public class TeacherController {
    ...
    public String teacherConnection(Principal principal, Model model){
        ...
        List<Connection> connections = teacherService.getStudentWhoAsked(teacherEmail);
        model.addAttribute("connections", connections); //우리가 넘겨주는 거 선생님한테 매칭을 요청한 학생들의 이메일주소
